# backend/services/email/email_pipeline.py
...
class EmailPipeline:
    ...
    def process_new_email(self):
        ...
        if not emails:
            ...
            return {"summary": "No new unread emails", "actions_taken": 0, "notifications": []}
        ...
        if sms_parts:
            ...
            send_result = self.tool_router.execute("send_sms", {
                "to": self.owner_phone,
                "body": message_body
            })
